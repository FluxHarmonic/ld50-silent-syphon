...
You can try out development builds of the game (*Linux Only* for now!) by downloading the =silent-syphon-linux= artifact from the latest CI run here:

https://github.com/FluxHarmonic/ld50-silent-syphon/actions
